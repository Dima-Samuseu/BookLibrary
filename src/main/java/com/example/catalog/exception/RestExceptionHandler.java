...
public class RestExceptionHandler {
    ...
    public ResponseEntity<Object> handlerBookNotFoundException(IncorrectDataException ex) {
    ...
    public ResponseEntity<Object> handlerBookTitleNotFoundException(BookTitleNotFoundException ex) {

        HttpStatus status = HttpStatus.BAD_REQUEST;
        log.error("Book by title not found" + ex.getMessage());
        return new ResponseEntity<>(ex.getMessage(), status);
    }
